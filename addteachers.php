...
$flag=0;
if(isset($_POST['add']))
{$result=mysqli_query($con,"insert into teacher(tid,tname,address,phone,speciality)values('$_POST[tid]','$_POST[tname]','$_POST[address]','$_POST[phone]','$_POST[speciality]')");
if($result)
{$flag=1;}
}
if(isset($_POST['delete']))
{$result=mysqli_query($con,"delete from teacher where tname='$_POST[tname]' and tid='$_POST[tid]'");
...
<a class="btn btn-success" href="teachers.php"> Back</a>
